...
class DoctorViewSerializer(serializers.Serializer):
...
class DoctorAppointmentSerializer(serializers.Serializer):
    pet_name=serializers.SerializerMethodField('related_pet_name')
    pet_age=serializers.SerializerMethodField('related_pet_age')
    ...
    pet_history=DoctorViewSerializer(label='pet History:')
    

    def related_patient_name(self, obj):
        return obj.pet_history.pet.get_name
    
    def related_patient_age(self, obj):
        return obj.pet_history.pet.age